          ...
          <div class="box">
            <div class="box-body box-profile">
              <?php if (@$data[0]['user_foto'] == ''): ?>
                <img class="img-thumbnail img-responsive" src="<?php echo base_url() ?>asset/gambar/user/no.jpg" alt="User profile picture" style="margin-bottom: 5%;">
              <?php else: ?>
                <img class="img-thumbnail img-responsive" src="<?php echo base_url() ?>asset/gambar/user/<?php echo @$data[0]['user_foto']; ?>" alt="User profile picture" style="margin-bottom: 5%;">
              <?php endif ?>
