    ...
    <?php endif ?>
	 ...
	 <div class="box">
	    ...
	    <div class="box-body">
		    ...
		    <form role="form" method="POST" action="<?php echo base_url('bumn_log/pelatihan_save') ?>" enctype="multipart/form-data">
			                    	 ...
			                    	 <div class="modal fade" id="modal_hapus<?php echo $i ?>">
							          <div class="modal-dialog" align="center">
			                            ...
			                            <div class="modal-body" align="center">
			                               <a href="<?php echo base_url('bumn_log/delete_pelatihan/'.$key) ?>"><button class="btn btn-success" type="button" style="width: 49%;">Yes</button></a>
