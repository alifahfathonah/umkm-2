    ...
    <?php endif ?>
      ...
      <div class="box">
        <div class="box-header with-border">
            ...
            <div align="left">
              <a href="<?php echo base_url('log_pameran/insert') ?>"><button class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data</button></a>
            </div>
          ...
          <table id="example1" class="table table-bordered table-hover">
                ...
                <?php foreach ($data as $key): ?>
                  ...
                  <tr>
                    ...
                    <td style="width: 50px;">
                      <div>
                      <a href="<?php echo base_url('log_pameran/update/').$key['log_pameran_id'] ?>"><button class="btn btn-xs btn-primary" ><i class="fa fa-edit"></i></button></a>
                      ...
                      <div class="modal-dialog" align="center">
                        <div class="modal-content" style="max-width: 300px;">
                          ...
                          <div class="modal-body" align="center">
                             <a href="<?php echo base_url() ?>log_pameran/delete/<?php echo $key['log_pameran_id'] ?>"><button class="btn btn-success" style="width: 49%;">Yes</button></a>
