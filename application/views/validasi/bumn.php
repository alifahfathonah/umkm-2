              ...
              <?php $i = 1; ?>
                <?php foreach ($data as $key): ?>
                  <tr>
                    ...
                    <td width="110">
                      <a href="<?php echo base_url('validasi/konfirm/'.$key['user_id'].'/2') ?>"><button class="btn btn-xs btn-success" type="button">Validasi <i class="fa fa-check"></i></button></a>
                  ...
                  <div class="modal-dialog" align="center">
                    <div class="modal-content" style="max-width: 300px;">
                      ...
                      <div class="modal-body" align="center">
                         <a href="<?php echo base_url('validasi/delete/'.$key['user_id'].'/2') ?>"><button class="btn btn-success" style="width: 49%;">Yes</button></a>
