                        ...
                        <div class="modal-body">
                          <form role="form" method="post" action="<?php echo base_url() ?>user/update/<?php echo $key['user_id'] ?>" enctype="multipart/form-data">
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                <label>Email</label>
                                <input required="" type="email" name="user_email" class="form-control" placeholder="Email" value="<?php echo $key['user_email'] ?>">
                              </div>
                              <!-- <div class="form-group">
                                <label>Level</label>
                                <select class="form-control" required="" name="user_level">
                                  <option hidden="" value="<?php echo $key['user_level'] ?>"><?php echo ucwords($key['user_level']) ?></option>
              ...
              <div class="modal-body">
                <form role="form" method="post" action="<?php echo base_url() ?>user/add" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Email</label>
                      <input required="" type="email" name="user_email" class="form-control" placeholder="Email">
                    </div>
                    <div class="form-group">
                      <label>Password</label>
                      <input required="" type="password" name="user_password" class="form-control" placeholder="Password">
                    </div>
                    <!-- <div class="form-group">
                      <label>Level</label>
                      <select class="form-control" required="" name="user_level">
