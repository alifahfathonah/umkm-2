...
class Data_bumn extends CI_Controller{ 
	...
	function index(){
		if ( $this->session->userdata('login') == 1) {
		    ...
		    $data['data'] = $this->db->query("SELECT * FROM t_user AS a JOIN t_bumn AS b ON a.user_foreignkey = b.bumn_user WHERE a.user_level = '1' AND a.user_hapus = 0")->result_array();
